...
// Obtener lista de horarios de juego
function obtenerHorariosJuego($conn) {
...
<head>
  ...
  <title>Consultar Horarios de Juego</title>
...
<div class="container mt-5">
  <div class="row justify-content-center">
    <div class="col-md-8">
      <h2 class="text-center">Consultar Horarios de Juego</h2>

      <!-- Lista de Horarios de Juego -->
      <table class="table mt-3">
        ...
        <tbody>
          <?php
          // Obtener lista de horarios de juego
          $resultHorarios = obtenerHorariosJuego($conn);
